        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockedDates = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    VehicleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilityCalendars", x => x.CalendarId);
                    table.ForeignKey(
                        name: "FK_AvailabilityCalendars_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityCalendars_VehicleId",
